...
import { Home, Map as MapIcon, Sparkles, AlertTriangle, Sun, Moon } from 'lucide-react';
...
const NAV_ITEMS_DATA = [
  ...
  { key: 'forecast', path: '/forecast-intelligence', icon: MapIcon }, // reuse icon or use another one
  { key: 'chat', path: '/chat', icon: Sparkles, badge: '7 Agents' },
  { key: 'map', path: '/map', icon: MapIcon },
  { key: 'alerts', path: '/alerts', icon: AlertTriangle },
  // { key: 'locations', path: '/locations', icon: MapPin }, // Disabled as Locations is deferred
];
