...
export function AiSynthesisBanner({
  ...
  return (
    <div className="p-4 bg-linear-to-r from-slate-900/90 via-slate-900/80 to-blue-950/40 border border-slate-800/90 rounded-2xl backdrop-blur-md flex flex-col md:flex-row items-start md:items-center justify-between gap-4 shadow-sm">
      ...
      <div className="flex items-center gap-2 self-end md:self-center shrink-0">
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-medium bg-slate-800/80 hover:bg-slate-700/80 text-slate-200 border border-slate-700/60 transition cursor-pointer"
        >
